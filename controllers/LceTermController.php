 ...
 */
class LceTermController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Displays a single LceTerm model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing LceTerm model.
    ...
    /**
     * Deletes an existing LceTerm model.
    ...
    {
        if (($model = LceTerm::findOne(['Uuid'=>$id])) !== null) {
            return $model;
        }
